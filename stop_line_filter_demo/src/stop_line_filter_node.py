...
class StopLineFilterNode(object):
    def __init__(self):
        ...
        self.sub_segs      = rospy.Subscriber("stop_line_filter_node/segment_list", SegmentList, self.processSegments)
        self.sub_lane      = rospy.Subscriber("stop_line_filter_node/lane_pose",LanePose, self.processLanePose)
